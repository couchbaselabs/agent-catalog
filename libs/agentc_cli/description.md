**Note: This package contains the command-line interface (CLI) component of the Couchbase Agent Catalog. For the primary, front-facing package that includes both the SDK and CLI, please install agentc**

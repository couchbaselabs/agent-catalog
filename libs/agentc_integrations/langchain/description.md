**Note: This package provides the LangChain integration for the Couchbase Agent Catalog. It is designed to be used as a component of the larger offering. To get started, we recommend installing the main agentc package.**

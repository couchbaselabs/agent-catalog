...
from agentc_core.catalog.version import catalog_schema_version_compare
from agentc_core.catalog.version import lib_version
from agentc_core.catalog.version import lib_version_compare
from agentc_core.defaults import DEFAULT_META_CATALOG_NAME
...
def load_repository(top_dir: pathlib.Path = None):
    ...
    # of rosetta-agentc_core. The agentc CLI / library should be run in

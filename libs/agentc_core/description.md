**Note: This package is the core Python SDK component of the Couchbase Agent Catalog. For the primary, front-facing package that includes the CLI and standard dependencies, please install agentc**

...
from libs.agent_catalog_libs.core.defaults import DEFAULT_HTTP_FTS_PORT_NUMBER
from libs.agent_catalog_libs.core.defaults import DEFAULT_HTTPS_FTS_PORT_NUMBER
